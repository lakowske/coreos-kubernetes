...
function init_config {
    local REQUIRED=( 'ADVERTISE_IP' 'INTERNAL_IP' 'ETCD_ENDPOINTS' 'CONTROLLER_ENDPOINT' 'DNS_SERVICE_IP' 'K8S_VER' 'HYPERKUBE_IMAGE_REPO' 'USE_CALICO' )
...
function init_templates {
    # The admin secret is hard-coded for simplicity of a demo. In production this would not be specified in which case rook will generate a random secret
